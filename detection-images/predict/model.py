...
class GeneralizedRCNNTransform(nn.Module):
    ...
    def resize(self, image, target):
        ...
        image = torch.nn.functional.interpolate(
            image[None], scale_factor=scale_factor, mode='area')[0]
...
class FasterRCNN(GeneralizedRCNN):
    ...
    def __init__(self, backbone, num_classes=None,
                 ...
                 box_score_thresh=0.05, box_nms_thresh=0.5, box_detections_per_img=50,
        ...
        if rpn_anchor_generator is None:
            anchor_sizes = ((16,), (32,), (48,), (64,), (128,), (300,))
            aspect_ratios = ((0.5, 1.0, 2.0, 5.0, 10.0),) * len(anchor_sizes)
...
class ResNet(nn.Module):
    def __init__(self, block=ResidualBlock, layers=(2,2,2), num_classes=10):
        ...
        self.features.out_channels=64
        self.clf = nn.Linear(8*8*64, 8)
...
class TrackDetectionModel(nn.Module):
